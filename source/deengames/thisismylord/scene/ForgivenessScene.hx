...
class ForgivenessScene extends Scene
{
  /**
  ...
  */
  override public function create():Void
  {
    ...
    this.nextScene = new deengames.thisismylord.scene.DedicateScene();
    this.loadAndPlay('assets/audio/speech/scene-15-forgiveness');
    super.create();
  }
